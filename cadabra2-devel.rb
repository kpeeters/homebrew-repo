...
class Cadabra2Devel < Formula
  ...
  url "https://github.com/kpeeters/cadabra2/archive/b3c8be20ec431b9a9b9d853a139460a672f1b393.tar.gz"
  sha256 "f46a8e2ad7398c1cff3764be5eaa5ddf22c2c3220f73a5519e2edfac2cdb2fc8"
  conflicts_with "cadabra2", because: "You can only install the normal or the devel version, not both."
  version "2.5.13.b3c8be20ec431b9a9b9d853a139460a672f1b393"
...
resource "wcwidth" do
  ...
  def install
    ...
    vinv.pip_install resource("decorator")
    vinv.pip_install resource("executing")
    vinv.pip_install resource("ipykernel")
    vinv.pip_install resource("ipython")
    vinv.pip_install resource("ipython_pygments_lexers")
    vinv.pip_install resource("jedi")
    vinv.pip_install resource("jupyter_client")
    vinv.pip_install resource("jupyter_core")
    vinv.pip_install resource("matplotlib-inline")
    vinv.pip_install resource("nest-asyncio")
    vinv.pip_install resource("parso")
    vinv.pip_install resource("pexpect")
    vinv.pip_install resource("platformdirs")
    vinv.pip_install resource("prompt_toolkit")
    vinv.pip_install resource("psutil")
    ...
    vinv.pip_install resource("wcwidth")
